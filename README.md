...
- [hashicorp/terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ([v5.56.0](https://github.com/hashicorp/terraform-provider-aws/releases/tag/v5.56.0), today) - The AWS Provider enables Terraform to manage AWS resources.
- [linkerd/linkerd2](https://github.com/linkerd/linkerd2) ([edge-24.6.4](https://github.com/linkerd/linkerd2/releases/tag/edge-24.6.4), today) - Ultralight, security-first service mesh for Kubernetes. Main repo for Linkerd 2.x.
