...
- [linkerd/linkerd2](https://github.com/linkerd/linkerd2) ([edge-24.6.2](https://github.com/linkerd/linkerd2/releases/tag/edge-24.6.2), 1 day ago) - Ultralight, security-first service mesh for Kubernetes. Main repo for Linkerd 2.x.
...
- [argoproj/argo-rollouts](https://github.com/argoproj/argo-rollouts) ([v1.7.0](https://github.com/argoproj/argo-rollouts/releases/tag/v1.7.0), 2 days ago) - Progressive Delivery for Kubernetes
...
- [kubernetes-sigs/external-dns](https://github.com/kubernetes-sigs/external-dns) ([external-dns-helm-chart-1.14.5](https://github.com/kubernetes-sigs/external-dns/releases/tag/external-dns-helm-chart-1.14.5), 5 days ago) - Configure external DNS servers (AWS Route53, Google CloudDNS and others) for Kubernetes Ingresses and Services
- [traefik/traefik](https://github.com/traefik/traefik) ([v3.0.2](https://github.com/traefik/traefik/releases/tag/v3.0.2), 5 days ago) - The Cloud Native Application Proxy
...
- [[kube-prometheus-stack] bump chart deps](https://github.com/prometheus-community/helm-charts/pull/4601) on [prometheus-community/helm-charts](https://github.com/prometheus-community/helm-charts) (4 days ago)
