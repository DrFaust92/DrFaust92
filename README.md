...
- [SeleniumHQ/docker-selenium](https://github.com/SeleniumHQ/docker-selenium) ([selenium-grid-0.37.1](https://github.com/SeleniumHQ/docker-selenium/releases/tag/selenium-grid-0.37.1), today) - Provides a simple way to run Selenium Grid with Chrome, Firefox, and Edge using Docker, making it easier to perform browser automation
