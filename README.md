...
- [grafana/mimir](https://github.com/grafana/mimir) ([mimir-3.0.0-rc.2](https://github.com/grafana/mimir/releases/tag/mimir-3.0.0-rc.2), 1 day ago) - Grafana Mimir provides horizontally scalable, highly available, multi-tenant, long-term storage for Prometheus.
