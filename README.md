...
- [linkerd/linkerd2](https://github.com/linkerd/linkerd2) ([edge-24.5.3](https://github.com/linkerd/linkerd2/releases/tag/edge-24.5.3), 5 days ago) - Ultralight, security-first service mesh for Kubernetes. Main repo for Linkerd 2.x.
