...
- [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ([v0.13.0](https://github.com/grafana/mcp-grafana/releases/tag/v0.13.0), 1 day ago) - MCP server for Grafana
...
- [[tempo-distributed] cleanup: drop dead K8s version guards](https://github.com/grafana-community/helm-charts/pull/432) on [grafana-community/helm-charts](https://github.com/grafana-community/helm-charts) (3 days ago)
- [[tempo-distributed] fix: re-wire dnsConfigOverides in shared pod template](https://github.com/grafana-community/helm-charts/pull/424) on [grafana-community/helm-charts](https://github.com/grafana-community/helm-charts) (3 days ago)
- [feat(vertex-ai): allow per-LLM-key GCP projectId override with ADC](https://github.com/langfuse/langfuse/pull/13357) on [langfuse/langfuse](https://github.com/langfuse/langfuse) (4 days ago)
- [chart(feature): add dnsPolicy and dnsConfig support](https://github.com/SeleniumHQ/docker-selenium/pull/3126) on [SeleniumHQ/docker-selenium](https://github.com/SeleniumHQ/docker-selenium) (4 days ago)
- [Publish charts as OCI artifacts to GHCR](https://github.com/percona/percona-helm-charts/pull/843) on [percona/percona-helm-charts](https://github.com/percona/percona-helm-charts) (5 days ago)
